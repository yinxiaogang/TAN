...
{	
	...
	if(0 == strcasecmp(inputParam->Detector, "CAPIX") || 0 == strcasecmp(inputParam->Detector, "MULSS"))
	{
			if(0 != strcasecmp(inputParam->cProductLevel, "L3"))
			{
						...
						{
							strcpy(tanfilename->DataName,"SCI");
							sprintf(tanfilename->IFL_CAPI_L1B_250_HDF, "TanSat_CAPI_1B_%s_%s_0250M_ORBT_%s_%s_%s_%s_%s.h5", tanfilename->DataName,tanfilename->Mode,inputParam->orbitnumber,
																			tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->Version,tanfilename->CAPI_CalibrationVer);
							sprintf(tanfilename->IFL_CAPI_L1B_250_GEO_HDF, "TanSat_CAPI_1B_%s_%s_GEOQK_ORBT_%s_%s_%s_%s_%s.h5",tanfilename->DataName,tanfilename->Mode,inputParam->orbitnumber,
																				tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->Version,tanfilename->CAPI_CalibrationVer);
							sprintf(tanfilename->IFL_CAPI_L1B_1KM_HDF, "TanSat_CAPI_1B_%s_%s_1000M_ORBT_%s_%s_%s_%s_%s.h5",tanfilename->DataName,tanfilename->Mode,inputParam->orbitnumber,
																			tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->Version,tanfilename->CAPI_CalibrationVer);
							sprintf(tanfilename->IFL_CAPI_L1B_1KM_GEO_HDF, "TanSat_CAPI_1B_%s_%s_GEO1K_ORBT_%s_%s_%s_%s_%s.h5",tanfilename->DataName,tanfilename->Mode,inputParam->orbitnumber,
																					tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->Version,tanfilename->CAPI_CalibrationVer);
							sprintf(tanfilename->IFL_CAPI_L1B_JPG, "TanSat_CAPI_1B_%s_%s_%s_ORBT_%s_%s_%s_%s_%s_%s.JPG",tanfilename->DataName,tanfilename->Mode,tanfilename->CAPIJPGresolution,inputParam->orbitnumber,
										tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->Version,tanfilename->CAPI_CalibrationVer,tanfilename->Channel);
							sprintf(tanfilename->IFL_CAPI_L1B_OBC_HDF, "TanSat_CAPI_1B_OBC_%s_%s_ORBT_%s_%s_%s_%s_%s.h5",tanfilename->Mode,tanfilename->CAPIOBCresolution,inputParam->orbitnumber,
																					tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->Version,tanfilename->CAPI_CalibrationVer);
						...
						{
							strcpy(tanfilename->DataName,"CAL");
							sprintf(tanfilename->IFL_CAPI_L1B_CAL_HDF, "TanSat_CAPI_1B_CAL_%s_%s_ORBT_%s_%s_%s_%s_%s.h5",tanfilename->Mode,tanfilename->CAPICALresolution,inputParam->orbitnumber,
																						tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->Version,tanfilename->CAPI_CalibrationVer);
				...
				if(0 == strcasecmp(tanfilename->DataName, "SCI"))
				{
					...
					sprintf(tanfilename->IFL_CAPI_L2_AER_HDF, "TanSat_CAPI_L2_AER_%s_%s_ORBT_%s_%s_%s_%s_%s.h5",tanfilename->Mode,tanfilename->AERresolution,inputParam->orbitnumber,
																tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->AERVersion,tanfilename->CAPI_CalibrationVer);
					sprintf(tanfilename->IFL_CAPI_L2_AER_JPG, "TanSat_CAPI_L2_AER_%s_%s_ORBT_%s_%s_%s_%s_%s_%s.JPG",tanfilename->Mode,tanfilename->AERresolution,inputParam->orbitnumber,
					...
					sprintf(tanfilename->IFL_CAPI_L2_CLM_HDF, "TanSat_CAPI_L2_CLM_%s_%s_ORBT_%s_%s_%s_%s_%s.h5",tanfilename->Mode,tanfilename->CLMresolution,inputParam->orbitnumber,
									tanfilename->DataAcquireDate,tanfilename->DataAcquireTime,tanfilename->CLMVersion,tanfilename->CAPI_CalibrationVer);
					sprintf(tanfilename->IFL_CAPI_L2_CLM_JPG, "TanSat_CAPI_L2_CLM_%s_%s_ORBT_%s_%s_%s_%s_%s_%s.JPG",tanfilename->Mode,tanfilename->CLMresolution,inputParam->orbitnumber,
